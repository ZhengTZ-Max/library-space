...
const initQuickDateList = () => {
  ...
  state.quickDate = state.quickDateList[0]?.value;
};
...
<template>
  <div class="seatLibrary">
    <div class="header">
      <div class="leftTit">
        <a-breadcrumb>
          <template #separator><img src="@/assets/seat/titRightIcon.svg" alt="" /></template>
          <a-breadcrumb-item>选择馆舍<img src="@/assets/seat/titRightIcon.svg" alt="" /></a-breadcrumb-item>
          ...
          <a-col :xs="12" :sm="12" :md="8" :lg="8" :xl="8" :xxl="6">
            ...
            >
              ...
              <div class="bottomItem">
                ...
                <div v-if="item?.id == state.activeIndex" class="action">
                  <span>预约</span>
